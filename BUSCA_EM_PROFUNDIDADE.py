...
#ALGORITMO UTILIZANDO BUSCA EM PROFUNDIDADE COM O MÉTODO MINIMAX
...
def done(board):
    ...
    # Verificar se não há mais jogadas possíveis (empate)
...
def BUSCA_EM_PROFUNDIDADE(stdscr):
    curses.curs_set(0)
    start(stdscr)
...
if __name__ == '__main__':
    curses.wrapper(BUSCA_EM_PROFUNDIDADE)
